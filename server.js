...
app.get("/fruits/seed", (req, res) => {
    ...
    .then((data) => {
        ...
        .then((data) => {
            // send created fruits as json response to confirm creation
            res.json(data)
        })
    })
})

// index route - get - /fruits, using .then method
app.get("/fruits", (req, res) => {
    // find all the fruits
    Fruit.find({})
    // render a template after fruits are found
    .then((fruits) => {
...
////////////////////////////
const PORT = process.env.PORT // grabbing port number from the environment(env)
